...
- inspired by governed agent workflow research
- designed to integrate with external controllers later
- standalone local workbench today

Avoid:

- private URLs
- exact infrastructure maps
- internal bot tokens
- client names
- private receipt logs
